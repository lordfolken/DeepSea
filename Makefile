...
copy-files:
	...
	install -d -m 755 $(DESTDIR)/srv/salt/ceph/monitoring/grafana/files/dashboards
	install -m 644 srv/salt/ceph/monitoring/grafana/files/dashboards/*.json $(DESTDIR)/srv/salt/ceph/monitoring/grafana/files/dashboards
